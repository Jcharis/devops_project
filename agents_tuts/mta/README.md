...
search_agent = LlmAgent(
    name="ResearchAgent",
    model=MODEL,
    instruction="""You are a Research Agent. Use the search tool to retrieve information and return it in a structured way
    """,
...
root_agent2 = SequentialAgent(
    name="ResearchWriterPipelineAgent",
    sub_agents=[writer_agent,translator_agent]
    # The agents will run in the order provided: Researcher -> Writer 
)
